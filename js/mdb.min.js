        ...
        t(this).each(function() {
            ...
            if (!n.hasClass("browser-default")) {
                ...
                if (a && (n.parent().find("span.caret").remove(), n.parent().find("input").remove(), n.unwrap(), t("ul#select-options-" + a).remove()), "destroy" !== e) {
                    ...
                    v && (c = n.attr("searchable"), u = t('<span class="search-wrap ml-2"><div class="md-form mt-0"><input type="text" class="search form-control" placeholder="' + c + '"></div></span>'), d.append(u), u.find(".search").keyup(g));
